...
지금 할 일 (one wu-wei move): [a concrete, doable step]
...
4. Recommend what fits the current tilt — **not forced to A/B.** Beyond the user's
   binary, if the reading points there, these are valid too:
